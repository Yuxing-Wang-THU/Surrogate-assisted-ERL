...
def evaluate(agent, env, trials=8, render=False, seed=None):
    results = []
    ...
    print('Test seed:', seed, "Average score:", np.mean(results))
...
if __name__ == "__main__":
    ...
    evaluate(agent, env, render=args.render, seed=args.seed)
